...
float calculate_knee_angle(float hip_x, float hip_y, float knee_x, float knee_y) {
    float v1_x = hip_x - knee_x;
    float v1_y = hip_y - knee_y;

    float bottom_x = knee_x;
    float bottom_y = knee_y + 1.0f;

    float v2_x = bottom_x - knee_x; 
    float v2_y = bottom_y - knee_y; 
